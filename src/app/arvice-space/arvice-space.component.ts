...
export class ArviceSpaceComponent implements OnInit {
  ...
  nombre: any;
  fillerNav = [
    { name: "Home", route: "mostrarInmuebles", icon: "home", label: "Home", number: '0' ,  onClick:this.xd},
    { name: "Register", route: "Agregar", icon: "groups", label: "Registrar Usuario", number: '0',  onClick: this.xd },
  ...
  constructor(changeDetectorRef: ChangeDetectorRef, media: MediaMatcher, private router: Router, private httpService: HttpService,  private activatedRoute: ActivatedRoute) {
    ...
    this.yolo = this.httpService.getGlobalVariable();
  }
  ngOnInit(): void {
