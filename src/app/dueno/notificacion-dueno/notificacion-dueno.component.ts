...
@Component({
  selector: 'app-notificacion-dueno',
  templateUrl: './notificacion-dueno.component.html',
  styleUrls: ['./notificacion-dueno.component.scss']
})
export class NotificacionDuenoComponent implements OnInit {
